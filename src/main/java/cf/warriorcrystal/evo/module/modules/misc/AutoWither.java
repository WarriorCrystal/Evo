...
public class AutoWither extends Module {
    ...
    public AutoWither() {
        super("AutoWither", Category.MISC);
        Evo.getInstance().settingsManager.rSetting(placeDelay = new Setting("PlaceDelay", this, 2, 0, 20, true));
    }
    ...
    public void placeSoulSand() {
        ...
        if (soulSandItem == -1) {
            Command.sendClientMessage("No SoulSand Toggling");
            this.toggle();
        } else {
    ...
    public void placeSkull() {
        ...
        if (witherSkullItem == -1) {
            Command.sendClientMessage("No WitherSkulls Toggling");
            this.toggle();
        } else {
