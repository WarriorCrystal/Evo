...
public class NameTags extends Module {
    ...
    public NameTags() {
        ...
        Evo.getInstance().settingsManager.rSetting(range = new Setting("Range", this, 100, 0, 1000, false));
        Evo.getInstance().settingsManager.rSetting(reversed = new Setting("Reversed", this, false));
        Evo.getInstance().settingsManager.rSetting(armor = new Setting("Armor", this, true));
        Evo.getInstance().settingsManager.rSetting(hands = new Setting("HeldItems", this, true));
        Evo.getInstance().settingsManager.rSetting(gamemode = new Setting("Gamemode", this, true));
        Evo.getInstance().settingsManager.rSetting(ping = new Setting("Ping", this, true));
        Evo.getInstance().settingsManager.rSetting(health = new Setting("Health", this, true));
        ...
        Evo.getInstance().settingsManager.rSetting(friendColor = new Setting("FriendColor", this, "BLUE", friendColors));
        Evo.getInstance().settingsManager.rSetting(scale = new Setting("Scale", this, 0.05, 0.01, 0.09, false));
        Evo.getInstance().settingsManager.rSetting(burrowed = new Setting("Burrow", this, true));
        Evo.getInstance().settingsManager.rSetting(totemPop = new Setting("TotemPops", this, true));
    }
    ...
    public void renderName(EntityPlayer entityPlayer, double x, double y, double z) {
        ...
        if (Core.customFont.getValBoolean()) {
            width = Evo.getInstance().fontRenderer.getStringWidth(nameTag) / 2 + 1;
        }
        else {
        ...
        if (Core.customFont.getValBoolean()) {
            Evo.getInstance().fontRenderer.drawStringWithShadow(nameTag, -width, 10.0, -1);
        }
        else {
    ...
    private void renderEnchantText(ItemStack stack, int x, int y) {
        ...
        if (stack.getItem() instanceof ItemArmor || stack.getItem() instanceof ItemTool || stack.getItem() instanceof ItemSword || stack.getItem() instanceof ItemElytra) {
            ...
            if (Core.customFont.getValBoolean()) Evo.getInstance().fontRenderer.drawStringWithShadow(dmg + "%", x * 2 + 6, y + 22, new Color((int) (red * 255), (int) (green * 255), 0).getRGB());
        ...
        for (int index = 0; index < enchants.tagCount(); ++index) {
            ...
            if (enc != null) {
                ...
                if (Core.customFont.getValBoolean()) Evo.getInstance().fontRenderer.drawStringWithShadow(encName, x * 2 + 13, yCount + 35, -1);
    ...
    private void renderEnchantTextMax(ItemStack stack, int x, int y) {
        ...
        if (stack.getItem() instanceof ItemArmor || stack.getItem() instanceof ItemTool || stack.getItem() instanceof ItemSword || stack.getItem() instanceof ItemElytra) {
            ...
            int dmg = 100 - (int) (red * 100);
            if (Core.customFont.getValBoolean())
                Evo.getInstance().fontRenderer.drawStringWithShadow(dmg + "%", x * 2 + 6, y + 23, new Color((int) (red * 255), (int) (green * 255), 0).getRGB());
            else
            ...
            if (stack.getItem() instanceof ItemArmor || stack.getItem() instanceof ItemElytra) {
                if (Core.customFont.getValBoolean())
                    Evo.getInstance().fontRenderer.drawStringWithShadow(ChatFormatting.RED + "max", x * 2 + (spacingArmor / 2.2) - 5, yCount - 3, -1);
                else
                    fontRenderer.drawStringWithShadow("max", (float) (x * 2 + (spacingArmor / 2.2) - 5), yCount - 3, -1);
            } else {
                if(Core.customFont.getValBoolean()) Evo.getInstance().fontRenderer.drawStringWithShadow(ChatFormatting.RED + "max", (x * 2 + 23), yCount - 3, -1);
