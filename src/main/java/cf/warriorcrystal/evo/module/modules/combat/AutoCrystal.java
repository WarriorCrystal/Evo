...
public class AutoCrystal extends Module {
    ...
    public void setup() {
        ...
        Evo.getInstance().settingsManager.rSetting(explode);
        waitTick = new Setting("caTickDelay", this, 1, 0, 20.0, true);
        Evo.getInstance().settingsManager.rSetting(waitTick);
        range = new Setting("caHitRange", this, 5.0, 0.0, 10.0, false);
        Evo.getInstance().settingsManager.rSetting(range);
        walls = new Setting("caWallsRange", this, 3.5, 0.0, 10.0, false);
        Evo.getInstance().settingsManager.rSetting(walls);
        antiWeakness = new Setting("caAntiWeakness", this, true);
        Evo.getInstance().settingsManager.rSetting(antiWeakness);
        nodesync = new Setting("caNoDesync", this, true);
        Evo.getInstance().settingsManager.rSetting(nodesync);

        place = new Setting("caPlace", this, true);
        Evo.getInstance().settingsManager.rSetting(place);
        autoSwitch = new Setting("caAutoSwitch", this, true);
        Evo.getInstance().settingsManager.rSetting(autoSwitch);
        Evo.getInstance().settingsManager.rSetting(noGappleSwitch = new Setting("caNoGapSwitch", this, false));
        placeRange = new Setting("caPlaceRange", this, 5.0, 0.0, 10.0, false);
        Evo.getInstance().settingsManager.rSetting(placeRange);
        minDmg = new Setting("caMinDamage", this, 5.0, 0.0, 40.0, false);
        Evo.getInstance().settingsManager.rSetting(minDmg);
        facePlace = new Setting("caFaceplaceHP", this, 6.0, 0.0, 40.0, false);
        Evo.getInstance().settingsManager.rSetting(facePlace);
        raytrace = new Setting("caRaytrace", this, false);
        Evo.getInstance().settingsManager.rSetting(raytrace);
        rotate = new Setting("caRotate", this, true);
        Evo.getInstance().settingsManager.rSetting(rotate);
        spoofRotations = new Setting("caSpoofAngles", this, true);
        Evo.getInstance().settingsManager.rSetting(spoofRotations);
        Evo.getInstance().settingsManager.rSetting(maxSelfDmg = new Setting("caMaxSelfDmg", this, 10, 0, 36, false));
        chat = new Setting("caToggleMsgs", this, true);
        Evo.getInstance().settingsManager.rSetting(chat);
        ...
        Evo.getInstance().settingsManager.rSetting(espR);
        espG = new Setting("caEspGreen", this, 50, 0, 255, true);
        Evo.getInstance().settingsManager.rSetting(espG);
        espB = new Setting("caEspBlue", this, 200, 0, 255, true);
        Evo.getInstance().settingsManager.rSetting(espB);
        espA = new Setting("caEspAlpha", this, 50, 0, 255, true);
        Evo.getInstance().settingsManager.rSetting(espA);
    }
    ...
    public void onWorldRender(RenderEvent event) {
        ...
        if (render != null && mc.player != null) {
            ...
            if(rainbow.getValBoolean()) {
                EvoTessellator.drawBox(render, c.getRGB(), GeometryMasks.Quad.ALL);
            } else {
            EvoTessellator.drawBox(render, (int) espR.getValDouble(), (int) espG.getValDouble(), (int) espB.getValDouble(), (int) espA.getValDouble(), GeometryMasks.Quad.ALL);
            }
