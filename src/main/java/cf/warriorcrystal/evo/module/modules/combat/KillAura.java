...
public class KillAura extends Module {
    ...
    public void setup(){
        ...
        Evo.getInstance().settingsManager.rSetting(criticals = new Setting("kaCriticals", this, false));
        Evo.getInstance().settingsManager.rSetting(swordOnly = new Setting("kaSwordOnly", this, false));
        Evo.getInstance().settingsManager.rSetting(caCheck = new Setting("CAuraCheck", this, false));
