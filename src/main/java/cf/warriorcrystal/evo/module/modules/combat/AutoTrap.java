...
public class AutoTrap extends Module {
    ...
    public void setup(){
        Evo.getInstance().settingsManager.rSetting(rotate = new Setting("atRotate", this, true));
        Evo.getInstance().settingsManager.rSetting(ec = new Setting("atUseEchests", this, false));
        Evo.getInstance().settingsManager.rSetting(range = new Setting("atRange", this, 5, 0, 10, false));
        Evo.getInstance().settingsManager.rSetting(bpt = new Setting("atBlocksPerTick", this, 8, 1, 15, true));
    }
