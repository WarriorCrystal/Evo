...
import cf.warriorcrystal.evo.util.Pair;
...
public class AutoReplenish extends Module {
    public AutoReplenish() {
        super("AutoReplenish", Category.PLAYER);
    }
    Setting threshold;
    Setting tickDelay;
    private int delayStep = 0;
    public void setup(){
        tickDelay = new Setting("TickDelay", this, 4, 0, 20, true);
        Evo.getInstance().settingsManager.rSetting(tickDelay);
        threshold = new Setting("Threshold", this, 4, 0, 20, true);
        Evo.getInstance().settingsManager.rSetting(threshold);
    }
