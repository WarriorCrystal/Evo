...
import cf.warriorcrystal.evo.friends.Friend;
...
import cf.warriorcrystal.evo.module.modules.chat.AutoGG;
...
public class ConfigUtils {
    ...
    public ConfigUtils() {
        this.EvoFile = new File(mc.gameDir + File.separator + "Evo");
        if (!this.EvoFile.exists()) {
            this.EvoFile.mkdirs();
        }

        this.Settings = new File(mc.gameDir + File.separator + "Evo" + File.separator + "Settings");
    ...
    public void saveBinds() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "Binds.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
            Iterator var3 = Evo.getInstance().moduleManager.getModules().iterator();
    ...
    public void loadBinds() {
        try {
            ...
            while((line = br.readLine()) != null) {
                ...
                for(Module m : Evo.getInstance().moduleManager.getModules()) {
    ...
    public void saveMacros() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "Macros.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
            Iterator var3 = Evo.getInstance().macroManager.getMacros().iterator();
    ...
    public void loadMacros() {
        try {
            ...
            while((line = br.readLine()) != null) {
                ...
                Evo.getInstance().macroManager.addMacro(new Macro(Keyboard.getKeyIndex(bind), value.replace("_", " ")));
            }
    ...
    public void saveWaypoints() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "Waypoints.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
            Iterator var3 = Evo.getInstance().waypointManager.getWaypoints().iterator();
    ...
    public void loadWaypoints() {
        try {
            ...
            while((line = br.readLine()) != null) {
                ...
                Evo.getInstance().waypointManager.addWaypoint(new Waypoint(name, xx, yy, zz, c));
            }
    ...
    public void saveAnnouncer() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "Announcer.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
    ...
    public void saveSpammer() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "Spammer.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
    ...
    public void saveMods() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "EnabledModules.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
            Iterator var3 = Evo.getInstance().moduleManager.getModules().iterator();
    ...
    public void saveFriends() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "Friends.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
    ...
    public void loadFriends() {
        try {
            ...
            String line;
            while((line = br.readLine()) != null) {
                Evo.getInstance().friends.addFriend(line);
            }
    ...
    public void saveGui() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "Gui.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
    ...
    public void saveHudComponents() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "HudComponents.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
    ...
    public void savePrefix() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "CommandPrefix.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
    ...
    public void saveFont() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "Font.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
            out.write(Evo.fontRenderer.getFontName()+ ":" + Evo.fontRenderer.getFontSize());
            out.write("\r\n");
            out.close();
        } catch (Exception var3) {
        }
    ...
    public void loadFont() {
        try {
            ...
            while((line = br.readLine()) != null) {
                ...
                Evo.fontRenderer = new CFontRenderer(new Font(name, Font.PLAIN, sizeInt), true, false);
                Evo.fontRenderer.setFont(new Font(name, Font.PLAIN, sizeInt));
                Evo.fontRenderer.setAntiAlias(true);
                Evo.fontRenderer.setFractionalMetrics(false);
                Evo.fontRenderer.setFontName(name);
                Evo.fontRenderer.setFontSize(sizeInt);
            }
    ...
    public void saveAutoGG() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "AutoGgMessage.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
    ...
    public void saveAutoReply() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "AutoReplyMessage.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
    ...
    public void saveRainbow() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "RainbowSpeed.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
    ...
    public void saveMsgs() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "ClientMessages.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
    ...
    public void saveDrawn() {
        try {
            File file = new File(this.EvoFile.getAbsolutePath(), "Drawn.txt");
            BufferedWriter out = new BufferedWriter(new FileWriter(file));
            Iterator var3 = Evo.getInstance().moduleManager.getModules().iterator();
    ...
    public void writeCrash(String alah) {
        try {
            ...
            Date date = new Date();
            File file = new File(this.EvoFile.getAbsolutePath(), "crashlog-".concat(format.format(date)).concat(".bruh"));
    ...
    public void loadMods() {
        try {
            ...
            String line;
            while((line = br.readLine()) != null) {
                Iterator var6 = Evo.getInstance().moduleManager.getModules().iterator();
    ...
    public void saveSettingsList() {
        ...
        try {
            ...
            var3 = cf.warriorcrystal.evo.Evo.getInstance().settingsManager.getSettings().iterator();
    ...
    public void loadSettingsList() {
        ...
        try {
            ...
            while((line = br.readLine()) != null) {
                ...
                m = curLine.split(":")[2];
                for(Module mm : Evo.getInstance().moduleManager.getModules()) {
                    if (mm != null && mm.getName().equalsIgnoreCase(m)) {
                        mod = cf.warriorcrystal.evo.Evo.getInstance().settingsManager.getSettingByName(name);
