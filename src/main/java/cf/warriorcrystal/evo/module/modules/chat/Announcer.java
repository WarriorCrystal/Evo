...
public class Announcer extends Module {
    ...
    public static String walkMessage = "I just walked {blocks} blocks thanks to Evo!";
    public static String placeMessage = "I just placed {amount} {name} thanks to Evo!";
    public static String jumpMessage = "I just jumped thanks to Evo!";
    public static String breakMessage = "I just broke {amount} {name} thanks to Evo!";
    public static String attackMessage = "I just attacked {name} with a {item} thanks to Evo!";
    public static String eatMessage = "I just ate {amount} {name} thanks to Evo!";
    public static String guiMessage = "I just opened my ClickGUI thanks to Evo!";

    public void setup(){
        Evo.getInstance().settingsManager.rSetting(clientSide = new Setting("anClientSide", this, true));
        Evo.getInstance().settingsManager.rSetting(walk = new Setting("anWalk", this, true));
        Evo.getInstance().settingsManager.rSetting(place = new Setting("anBlockPlace", this, false));
        Evo.getInstance().settingsManager.rSetting(jump = new Setting("anJump", this, false));
        Evo.getInstance().settingsManager.rSetting(breaking = new Setting("anBlockBreak", this, false));
        Evo.getInstance().settingsManager.rSetting(attack = new Setting("anAttackEntity", this, false));
        Evo.getInstance().settingsManager.rSetting(eat = new Setting("anEat", this, false));
        Evo.getInstance().settingsManager.rSetting(clickGui = new Setting("anClickGui", this, false));
        Evo.getInstance().settingsManager.rSetting(delay = new Setting("anDelayMultiplier", this, 1, 1, 20, true));
    }
