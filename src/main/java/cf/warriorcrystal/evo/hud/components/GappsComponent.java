...
import cf.warriorcrystal.evo.module.modules.gui.Gapples;
...
public class GappsComponent extends Panel {
    ...
    public void drawHud(){
        doStuff();
        if(font) Evo.fontRenderer.drawStringWithShadow(gaps, (float)x, (float)y, text.getRGB());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks){
        ...
        if(extended) {
            ...
            if (font) Evo.fontRenderer.drawStringWithShadow(gaps, (float) x, (float) startY, text.getRGB());
