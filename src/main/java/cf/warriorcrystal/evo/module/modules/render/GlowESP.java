...
public class GlowESP extends Module {
    ...
    public void setup(){
        Evo.getInstance().settingsManager.rSetting(players = new Setting("gPlayers", this, true));
        Evo.getInstance().settingsManager.rSetting(passive = new Setting("gPassive", this, false));
        Evo.getInstance().settingsManager.rSetting(monsters = new Setting("gMonsters", this, false));
        Evo.getInstance().settingsManager.rSetting(items = new Setting("gItems", this, false));
        Evo.getInstance().settingsManager.rSetting(crystals = new Setting("gCrystals", this, false));
        Evo.getInstance().settingsManager.rSetting(xpBottles = new Setting("gXpBottles", this, false));
    }
