...
public class GappsComponent extends Panel {
    ...
    public void drawHud(){
        doStuff();
        if(font) Evo.fontManager.getCFont().drawText(gaps, (float)x, (float)y, text.getRGB());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks){
        ...
        if(extended) {
            ...
            if (font) Evo.fontManager.getCFont().drawText(gaps, (float) x, (float) startY, text.getRGB());
