package com.evo.core.gui.click;
...
import com.evo.core.gui.click.components.Frame;
import com.evo.core.gui.click.components.buttons.ModuleButton;
import com.evo.core.shader.two.BlurShader;
...
public class ClickGUIScreen extends GuiScreen implements Wrapper {
    ...
    private ClickGUIScreen() {
        ...
        for (Category category : Category.values()) {
            List<Module> modules = getEvo().getModuleManager().getModules()
