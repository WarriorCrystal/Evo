...
public class PotionEffects extends Module {
    ...
    public void setup(){
        ...
        Evo.getInstance().settingsManager.rSetting(customFont = new Setting("fxCFont", this, false));
    }
    ...
    private int getWidth(String s){
        if(customFont.getValBoolean()) return Evo.fontRenderer.getStringWidth(s);
