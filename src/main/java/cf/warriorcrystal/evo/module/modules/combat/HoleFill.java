...
public class HoleFill extends Module {
    ...
    public void setup(){
        Evo.getInstance().settingsManager.rSetting(range = new Setting("hfRange", this, 5, 0, 10, false));
        Evo.getInstance().settingsManager.rSetting(yRange = new Setting("hfRangeY", this, 2, 0, 10, false));
        Evo.getInstance().settingsManager.rSetting(rotate = new Setting("hfRotate", this, true));
        Evo.getInstance().settingsManager.rSetting(waitTick = new Setting("hfTickDelay", this, 1, 0, 20, true));
        Evo.getInstance().settingsManager.rSetting(ec = new Setting("hfUseEC", this, false));
        Evo.getInstance().settingsManager.rSetting(chat = new Setting("hfChat", this, false));
    }
